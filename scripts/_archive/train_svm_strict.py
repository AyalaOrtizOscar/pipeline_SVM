# train_svm_strict.py (versión corregida)
...
from sklearn.model_selection import GroupKFold, GridSearchCV, train_test_split, GroupShuffleSplit
...
FEATURES_CSV = ROOT / "inputs" / "features_svm_baseline_limpios_originals.with_duration.csv"  # o features_per_file.csv
OUT_DIR = ROOT / "results" / ("svm_run_" + pd.Timestamp.now().strftime("%Y%m%d_%H%M%S"))
